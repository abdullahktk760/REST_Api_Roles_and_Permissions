      ...
      <div class="card card-congratulations">
        <div class="card-body text-center">
          ...
          <div class="text-center">
            <h1 class="mb-1 text-white">Assessment Test GublooTech</h1>
            <p class="card-text m-auto w-75">
                To test the RESTful API, use the <strong>Postman application</strong>. In the API, we have implemented features such as password reset via email, user login/registration, and user information retrieval etc.
            </p>
          </div>
        </div>
      </div>
